...
@section('setting')
    <div class="card">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <h3 class="font-semibold uppercase text-gray-600 dark:text-gray-400 m-2">{{ __('admin.settings.core.security.captcha.title') }}</h3>
            ...
            <h3 class="font-semibold uppercase text-gray-600 dark:text-gray-400 m-2">{{ __('admin.settings.core.security.auth') }}</h3>
