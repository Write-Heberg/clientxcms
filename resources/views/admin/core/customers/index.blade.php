                ...
                <div class="p-1.5 min-w-full inline-block align-middle">
                    ...
                    <span class="block px-6 py-2">
                        <span class="text-sm text-gray-600 dark:text-gray-400"><a href="mail:{{ $item->email }}">{{ $item->email }}</a></span>
                                        ...
                                        <td class="h-px w-px whitespace-nowrap">
                    <span class="block px-6 py-2">
                        <span class="text-sm text-gray-600 dark:text-gray-400"><a href="tel:{{ $item->phone }}">{{ $item->phone }}</a></span>
                    </span>
                                        </td>
                    ...
                    <span class="block px-6 py-2">
                      <span class="text-sm text-gray-600 dark:text-gray-400">{{ formatted_price($item->balance) }}</span>
                                    ...
                                    <td class="h-px w-px whitespace-nowrap">
                                        ...
                                        @if (staff_has_permission('admin.manage_customers'))
                                        <form method="POST" action="{{ route($routePath . '.show', ['customer' => $item]) }}" class="inline" onsubmit="return confirmation()">
                                            @method('DELETE')
                                            @csrf
                                            <button>
