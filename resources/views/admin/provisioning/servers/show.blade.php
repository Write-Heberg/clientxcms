    ...
    <div class="max-w-[85rem] py-5 lg:py-7 mx-auto">
        ...
        <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 sm:col-span-8">
                    <form method="POST" class="card" action="{{ route($routePath . '.update', ['server' => $item]) }}">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-col">
                                @include('admin/shared/input', ['name' => 'port', 'label' => __('admin.servers.port'), 'value' => old('port', $item->port)])
                            </div>
