        ...
        <div class="grid md:grid-cols-12 grid-cols-4 gap-2">
            <div class="md:col-span-8 mt-4 col-span-12 mt-4">
                <div class="grid grid-cols-1 gap-2">
                    @include('front/client/services/card', ['services' => $services, 'count' => $servicesCount, 'filters' => $serviceFilters, 'filter' => null])
                    @include('front/client/invoices/card', ['invoices' => $invoices, 'count' => $invoicesCount, 'filters' => $serviceFilters, 'filter' => null])
                    @include('front/client/helpdesk/support/card', ['tickets' => $tickets, 'count' => $ticketsCount, 'filters' => $serviceFilters, 'filter' => null])
                </div>
            </div>
