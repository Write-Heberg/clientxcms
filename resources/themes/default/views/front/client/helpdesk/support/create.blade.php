...
@section('title', __('client.support.create.newticket'))
@section('styles')
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                        ...
                        <div class="card-heading">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    {{ __('client.support.create.index_description') }}
                                </p>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('front.support.create') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="grid gap-6 sm:grid-cols-2 grid-cols-2">
                                    <div class="col-span-2 sm:col-span-1">
                                        @include("shared/input", ["name" => "subject", "label" => __("client.support.subject")])
                                    </div>
                                    <div class="col-span-2 sm:col-span-1">
                                        @include("shared/select", ["name" => "priority", "label" => __("client.support.priority"), "options" => $priorities, 'value' => old('priority')])
                                    </div>
                                    <div class="col-span-2 sm:col-span-1">
                                        @include("shared/select", ["name" => "related_id", "label" => __("client.support.create.relatedto"), "options" => $related, 'value' => old('related_id', 'none')])
                                    </div>
                                    <div class="col-span-2 sm:col-span-1">
      ...
      "optionTemplate": "<div><div class=\"flex items-center\"><div class=\"me-2\" data-icon></div><div class=\"font-semibold text-gray-800 dark:text-gray-200\" data-title></div></div><div class=\"mt-1.5 text-sm text-gray-500\" data-description></div></div>"
        ...
        "icon": "<i class=\"{{$department->icon}}\"></i>"
                                ...
                                <button type="submit" class="btn btn-primary mt-2">{{ __('client.support.create.send') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
