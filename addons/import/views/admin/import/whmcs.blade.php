...
@section('content')
            ...
            <div class="-m-1.5 overflow-x-auto">
                <div class="p-1.5 min-w-full inline-block align-middle">
                    ...
                    <div class="card">
                        ...
                        @if ($output == null)
                        <form method="POST" action="{{ route('admin.import.whmcs') }}">
  ...
  <label for="checkbox-{{ $k }}" class="text-sm text-gray-500 ms-3 dark:text-neutral-400">{{ $importable }}</label>
                            ...
                            @include('admin/shared/password', ['name' => 'key', 'label' => __('import::import.whmcs.key'), 'help' => __('import::import.whmcs.keyhelp')])
